...
st.set_page_config(
   ...
   page_icon=r'C:\Users\DELL\OneDrive\Desktop\Sarfraz\PW Data Science\Project\AI-Resume-Analyzer-main\Logo\ChatGPT Image Jan 9, 2026, 01_05_00 AM.png',
)
...
def run():
    ...
    img = Image.open(r'C:\Users\DELL\OneDrive\Desktop\Sarfraz\PW Data Science\Project\AI-Resume-Analyzer-main\screenshots\ChatGPT Image Jan 9, 2026, 01_05_00 AM.png')
    st.image(img)
    st.sidebar.markdown("# Choose Something...")
    activities = ["User", "Feedback", "About", "Admin"]
    choice = st.sidebar.selectbox("Choose among the given options:", activities)
    link = '<b>Built with 🤍 by <a href="https://www.linkedin.com/in/mohammad-sarfraz-khan-555877277/" style="text-decoration: none; color: #FF0000;"> Sarfraz Khan</a></b>' 
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with 🤍 by 
            <a  style="text-decoration: none; color: grey;">Sarfraz Khan</a> through 
            <a href="https://www.linkedin.com/in/mohammad-sarfraz-khan-555877277/" style="text-decoration: none; color: grey;">--(Data Scientist)</a>
        </p>
